...
//Funcao utilizada para mover o Animal de acordo com a anima√ß√£o
void Animal::advance(float dt) {
	...
	//chama a funcao step() a quantidade de vezes apropriada para a anima√ß√£o
	while (dt > 0) {
...
//Retorna o tipo do animal | Zebra ou Le√£o | 
int Animal::type() {
	return 0;
}

//Desenha um animal padr√£o | overreading nas classes especificas dos animais | 
void Animal::draw() {
	if (model == NULL) {
		return;
	}
	...
	glColor3f(1, 1, 1);
	//RotaÁ„o para o modelo virar para o sentido da animaÁ„o
	glRotatef(180.0f, 0.0f, 1.0f, 0.0f);
	//RotaÁ„o para o modelo ficar em pÈ
...
//Altera o angulo caso os animais se encontr√£o em uma colisao
...
//Altera a posi√ß√£o do Animal no vetor de animais
